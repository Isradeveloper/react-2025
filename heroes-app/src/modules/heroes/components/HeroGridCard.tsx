    ...
    <Card className="cursor-pointer group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        <Button
          ...
          <Heart
            className={`h-4 w-4 ${cn(isFavorite(hero) ? 'fill-red-500 text-red-500' : 'text-gray-600')}`}
          />
        </Button>
      ...
      <CardHeader className="py-3 z-10 bg-gray-100/70 backdrop-blur-sm relative top-1 group-hover:top-[20px] transition-all duration-400">
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <h3 className="font-bold text-lg leading-tight">{hero.alias}</h3>
            <p className="text-sm text-gray-900">{hero.name}</p>
          </div>
