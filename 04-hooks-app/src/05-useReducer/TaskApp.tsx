...
import { taskReducer, getTasksInitialState } from "./reducers/TaskReducer";
...
export const TasksApp = () => {
  ...
  const { todos, length, completed } = state;
        ...
        <Card className="mb-6 shadow-lg border-0 bg-white/80 backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex gap-2">
              ...
              <Button
                onClick={addTodo}
                className="bg-slate-800 hover:bg-slate-700 text-white px-4 cursor-pointer"
