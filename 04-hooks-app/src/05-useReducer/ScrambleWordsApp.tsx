...
import { scrambleWordsReducer } from "./reducers/ScrambleWordsReducer";
import { getInitialState } from "./reducers/ScrambleWordsReducer";
          ...
          <CardContent className="p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="text-center text-lg font-semibold h-12 border-2 border-indigo-200 focus-visible:ring-indigo-500 focus-visible:ring-1 transition-colors"
                ...
                <Button
                  type="submit"
                  className="w-full cursor-pointer bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                onClick={handleSkip}
                variant="outline"
                className="border-2 cursor-pointer border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
              ...
              <Button
                ...
                variant="outline"
                className="border-2 cursor-pointer border-indigo-300 hover:border-indigo-400 hover:bg-indigo-50 text-indigo-600 transition-colors flex items-center justify-center gap-2"
              >
